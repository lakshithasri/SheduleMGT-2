      ...
      <div className="sidebar-wrapper">
        <div className="logo-wrapper">
          <Link to={`${process.env.PUBLIC_URL}/dashboard/default`}>
            <h3 className="img-fluid for-light">Shedule Management</h3>
            <h3 className="img-fluid for-dark"> Shedule Management</h3>
            {/* <img
              className="img-fluid for-light"
              src={require("../../assets/images/logo/xx.jpeg")}
              alt=""
            /> */}
            {/* <img
              className="img-fluid for-dark"
              src={require("../../assets/images/logo/x.jpeg")}
              alt=""
            /> */}
          </Link>
